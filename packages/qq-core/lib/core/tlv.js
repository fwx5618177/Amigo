...
const map = {
    ...
    0x16: function () {
        const Watch = (0, device_1.getApkInfo)(device_1.Platform.Watch);
        return new writer_1.default()
    ...
    0x147: function () {
        return new writer_1.default().writeU32(this.apk.appid).writeTlv(this.apk.ver).writeTlv(this.apk.sign);
    },
    0x154: function () {
