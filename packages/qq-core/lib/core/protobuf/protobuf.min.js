        ...
        4: [
            function (t, n) {
                function i(t) {
                    function n(t, n, i, r) {
                        var u = n < 0 ? 1 : 0;
                        if ((u && (n = -n), 0 === n)) t(0 < 1 / n ? 0 : 2147483648, i, r);
                        else if (isNaN(n)) t(2143289344, i, r);
                        else if (34028234663852886e22 < n) t(((u << 31) | 2139095040) >>> 0, i, r);
                        else if (n < 11754943508222875e-54)
                            t(((u << 31) | Math.round(n / 1401298464324817e-60)) >>> 0, i, r);
                        else {
                            var e = Math.floor(Math.log(n) / Math.LN2);
                            t(
                                ((u << 31) |
                                    ((127 + e) << 23) |
                                    (8388607 & Math.round(n * Math.pow(2, -e) * 8388608))) >>>
                                    0,
                                i,
                                r,
                            );
                    ...
                    function v(t, n, i, r, u, e) {
                        ...
                        if ((s && (r = -r), 0 === r))
                            ...
                            t(0, u, e + n), t(((s << 31) | 2146435072) >>> 0, u, e + i);
                        else {
                            var h;
                            if (r < 22250738585072014e-324)
                                ...
                                1024 === f && (f = 1023),
                                    t(
                                        (4503599627370496 * (h = r * Math.pow(2, -f))) >>> 0,
                                        u,
                                        e + n,
                                    ),
                                    t(
                    ...
                    return (
                        'undefined' != typeof Float32Array
                            ? ((h = new Float32Array([-0])),
                              (f = new Uint8Array(h.buffer)),
                              (o = 128 === f[3]),
                              (t.writeFloatLE = o ? r : u),
                              (t.writeFloatBE = o ? u : r),
                              (t.readFloatLE = o ? e : s),
                              (t.readFloatBE = o ? s : e))
                            : ((t.writeFloatLE = n.bind(null, A)),
                              (t.writeFloatBE = n.bind(null, p)),
                              (t.readFloatLE = i.bind(null, m)),
                              (t.readFloatBE = i.bind(null, j))),
                        'undefined' != typeof Float64Array
                            ? ((c = new Float64Array([-0])),
                              (a = new Uint8Array(c.buffer)),
                              (l = 128 === a[7]),
                              (t.writeDoubleLE = l ? y : b),
                              (t.writeDoubleBE = l ? b : y),
                              (t.readDoubleLE = l ? d : g),
                              (t.readDoubleBE = l ? g : d))
                            : ((t.writeDoubleLE = v.bind(null, A, 0, 4)),
                              (t.writeDoubleBE = v.bind(null, p, 4, 0)),
                              (t.readDoubleLE = w.bind(null, m, 0, 4)),
                              (t.readDoubleBE = w.bind(null, j, 4, 0))),
                        t
                    );
                }
                function A(t, n, i) {
            ...
            function (t, n) {
                ...
                (h.create = f()),
                    ...
                    (h.prototype.uint32 =
                        ...
                        function () {
                            if (
                                ((o = (127 & this.buf[this.pos]) >>> 0), this.buf[this.pos++] < 128)
                            )
                                return o;
                            if (
                                ((o = (o | ((127 & this.buf[this.pos]) << 7)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return o;
                            if (
                                ((o = (o | ((127 & this.buf[this.pos]) << 14)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return o;
                            if (
                                ((o = (o | ((127 & this.buf[this.pos]) << 21)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return o;
                            if (
                                ((o = (o | ((15 & this.buf[this.pos]) << 28)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return o;
