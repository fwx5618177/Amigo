...
console.log(obj);
const tuple = Schema.tuple([Schema.const('123'), Schema.const(123)] as const)();
console.log(tuple);
...
console.log(union);
const intersect = Schema.intersect([Schema.const('123'), Schema.string()] as const)('123');
